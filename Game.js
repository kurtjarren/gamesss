...
const sentences = [
    "Ang pusa ay tumalon sa ibabaw ng bakod.",
    "Ang mabagal na pagong ay nagtago sa damuhan.",
    "Ang matamis na prutas ay nakasabit sa malaking puno.",
    "Ang malaking giraffe ay kumakain ng damo.",
